...
/// Nó usado pelo A* na fila de prioridade
#[derive(Copy, Clone, Eq, PartialEq)]
struct Node {
    pos: (usize, usize),
    f_cost: usize, // Custo total (g + h)
    g_cost: usize, // Custo do início até aqui
}

// Implementação de Ordenação para a BinaryHeap (fila de prioridade)
// A BinaryHeap do Rust é uma max-heap, então invertemos a lógica
// para que ela funcione como uma min-heap baseada no f_cost.
impl Ord for Node {
...
/// Reconstrói o caminho final a partir dos dados do A*
fn reconstruct_path(
...
/// Encontra o caminho mais curto entre dois pontos no grid usando A*
